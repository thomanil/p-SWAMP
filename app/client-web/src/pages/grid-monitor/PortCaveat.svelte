...
<Alert
  class="border-amber-300 bg-amber-50 text-amber-900 dark:border-amber-900/60 dark:bg-amber-950/40 dark:text-amber-100"
>
  <AlertTriangleIcon class="size-4" />
  <AlertTitle>Preliminary rough port of the Qt frontend code</AlertTitle>
  <AlertDescription class="text-amber-900/90 dark:text-amber-100/90">
    An exploratory early port of some of the prexisting QT GUI to TS+Svelte, connecting existing pSWAMP models and algorithms.
